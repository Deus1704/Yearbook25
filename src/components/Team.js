            ...
            <div className="team-cards-container">
              <div className="team-mobile-grid">
                {teamMembers.map((member, index) => (
                  <div className="team-mobile-card" key={index}>
                    <div className="card2 shadow2">
                      <div>
                        <img src={member.image} className="card-img-top" style={{ width: '100%', height: 'auto', aspectRatio: '1/1', objectFit: 'cover' }} alt={member.name} />
                  ...
                  <div className="team-card-wrapper" key={index}>
                    <div className="card">
                      <div className="first-content">
                        <img src={member.image} className="card-img-top" style={{ width: '100%', height: '100%', aspectRatio: '3/4' }} alt={member.name} />
                      </div>
                      <div className="second-content text-center">
                        ...
                        <ul className="example-2">
                          <li className="icon-content">
                            <a href={member.social.linkedin} aria-label="LinkedIn" data-social="linkedin">
                          ...
                          {member.social.github && member.social.github.trim() !== '' && (
                            <li className="icon-content">
                              <a href={member.social.github} aria-label="GitHub" data-social="github">
                                <div className="filled"></div>
                          ...
                          <li className="icon-content">
                            <a href={member.social.instagram} aria-label="Instagram" data-social="instagram">
                              <div className="filled"></div>
