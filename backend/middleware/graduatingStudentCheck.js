  ...
  try {
    ...
    if (!isGraduating) {
      return res.status(403).json({
        error: 'NotGraduating',
        message: 'You are not graduating yet, darling! 🎓 Come back when it\'s your turn to shine. You can still interact with the yearbook through comments, messages, and photo uploads.'
      });
    }
