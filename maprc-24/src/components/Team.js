...
const Home = () => {
  ...
  return (
    ...
    <div className="container" id='mobile' style={{display:'none'}}>
      <div className="row" style={{justifyContent:'space-around'}}>
        {filteredProfiles.map((profile, index) => (
          <div className="col-9 col-md-3 mb-3" key={index} style={{gap:'10px'}}>
            {/* <Link to={`/profile/${profile.id}`} className="text-decoration-none"> */}
              <div className="card2 shadow2 mb-3 mt-2">
                <div>
                  <img src={profile.image} className="card-img-top" style={{width:'100%', height:'100%'}} alt={profile.name} />
              ...
              {/* <Link to={`/profile/${profile.id}`} className="text-decoration-none"> */}
                <div className="card">
                  <div className="first-content">
                    <img src={profile.image} className="card-img-top" style={{width:'100%', height:'100%', aspectRatio:'3/4'}} alt={profile.name} />
                  </div>
